...
# Account Information
to = 'guoshanglinbest@gmail.com' # Email to send to.
gmail_user = 'secure.a4home@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = '124816326' # Gmail password.
